                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-10">
                            ...
                            <div className="flex gap-3 mt-2">
                                <label>
                                    ゆずの小町
                                    <input type="text" name="sales1" value={formData.sales1 ? formatNumber(formData.sales1) : ''} onChange={handleInputChange} className="block w-36 mt-1 px-4 border-gray-200 rounded-lg text-xs"  />
                                </label>
                                <label>
                                    キヨスグ
                                    <input type="text" name="sales2" value={formData.sales2 ? formatNumber(formData.sales2) : ''} onChange={handleInputChange} className="block w-36 mt-1 px-4 border-gray-200 rounded-lg text-xs" />
                                </label>
                            </div>
                        </div>
                        <div className="mb-10">
                            ...
                            <div className="flex gap-3 mt-2">
                                ...
                                <label>
                                    金額
                                    <input type="text" name="ses_amount" value={formData.ses_amount ? formatNumber(formData.ses_amount) : ''} onChange={handleInputChange} className="block w-36 mt-1 px-4 border-gray-200 rounded-lg text-xs" />
                        ...
                        <div>
                            ...
                            <div className="flex gap-3 mt-2">
                                ...
                                <label>
                                    金額
                                    <input type="text" name="other_amount" value={formData.other_amount ? formatNumber(formData.other_amount) : ''} onChange={handleInputChange} className="block w-36 mt-1 px-4 border-gray-200 rounded-lg text-xs" />
