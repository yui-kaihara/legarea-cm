...
class CashManagementFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ses_amount' => ['nullable', 'integer', 'min:0', 'required_with:company_name,personnel_name,ses_type,ses_bank'],
            ...
            'other_amount' => ['nullable', 'integer', 'min:0', 'required_with:summary_id,other_type,other_bank'],
